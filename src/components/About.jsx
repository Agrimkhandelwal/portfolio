...
`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-6 sm:mb-8">
          <div className="flex flex-col items-start">
            <p className="text-base sm:text-lg  sm:mb-6 text-green-300 h-[128px] mb-10 ">
            ...
            <div className="space-y-2 text-sm sm:text-base text-red-300 p-2 mt-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6 w-full sm:w-auto">
              <a
                href="https://drive.google.com/file/d/1-BetRLpYoDTGxfX7zkihPMF6Vi70Rw_8/view?usp=drive_link"
                target="_blank"
              ...
              <a
                href="mailto:agrimkhandelwal11@gmail.com"
          ...
          <div className="border-t md:border-t-0 md:border-l border-green-700 pt-6 md:pt-0 md:pl-8 space-y-4 sm:space-y-6">
            <a
              href="https://github.com/Agrimkhandelwal"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/agrim-khandelwal-95662527a/"
              target="_blank"
            ...
            <a
              href="https://x.com/agrim11_02?t=KVYR0Nk-2IGSrP1cs5tNBA&s=09"
              target="_blank"
            ...
            <a
              href="https://leetcode.com/u/agrimkhandelwal1/"
              target="_blank"
