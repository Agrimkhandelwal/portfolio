...
` ,
  help: `${window.innerWidth > 640 ? `         
         ...
         linkedin      Show Agrim's Linkedin account
         twitter       Show Agrim's Twitter account
         github        Show Agrim's Github account
         ...
         exit`}`,
  whois :
    "Hi! I'm Agrim, a passionate developer skilled in React, Node.js, and full-stack development.",
  projects:
    " 1. One Piece Memory Game | 2. Terminal Portfolio",
  github : `url("Agrim")`,
  date : `${new Date()}` ,
};
...
const Terminal = () => {
  ...
  const handleCommand = () => {
    if (input === "clear") {
      ...
      window.open("https://www.linkedin.com/in/agrim-khandelwal-95662527a/","_blank")
    }else if(input === "github"){
      window.open("https://github.com/Agrimkhandelwal","_blank")
    }else if(input === "twitter"){
      window.open("https://x.com/agrim11_02?t=KVYR0Nk-2IGSrP1cs5tNBA&s=09","_blank")
    }
     else {
